...
komorebic.exe manage-rule exe "Discord.exe"
...
# EA Desktop Client
komorebic.exe identify-border-overflow-application exe "EADesktop.exe"
...
# Target thumbnail/cropped window
